...
// Benchmark-owned aggregate report: used by all-verb benchmark suites, while CLI --perf stays per-operation. The all-verbs suite captures Atrium's in-process native search verbs alongside the rest of the MCP surface.
